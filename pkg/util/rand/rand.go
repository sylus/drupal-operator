...
var (
	alphaNumericStringGenerator = NewStringGenerator(letters)
	asciiStringGenerator        = NewStringGenerator(ascii)
)

// NewStringGenerator returns a cryptographically secure random sequence
